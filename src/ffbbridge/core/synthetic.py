...
DEFAULT_SCRIPT: tuple[Keyframe, ...] = (
    ...
    Keyframe(32.0, gs_kt=14.0, ias_kt=9.0, rpm=1000.0, throttle=0.25, running=True,
             surface=SurfaceType.GRASS),
    Keyframe(40.0, gs_kt=10.0, ias_kt=7.0, rpm=1000.0, throttle=0.2, running=True,
             surface=SurfaceType.GRASS),
    ...
    Keyframe(84.0, gs_kt=66.0, ias_kt=66.0, agl_ft=8.0, vs_fpm=350.0, rpm=2650.0,
             throttle=1.0, on_ground=False, running=True),
    Keyframe(95.0, gs_kt=78.0, ias_kt=78.0, agl_ft=500.0, vs_fpm=700.0, rpm=2600.0,
             throttle=1.0, gear=1.0, on_ground=False, running=True),
    Keyframe(140.0, gs_kt=90.0, ias_kt=88.0, agl_ft=2800.0, vs_fpm=650.0, rpm=2500.0,
             throttle=0.95, on_ground=False, running=True),
    # Cruise.
    Keyframe(155.0, gs_kt=118.0, ias_kt=112.0, agl_ft=3000.0, vs_fpm=0.0, rpm=2350.0,
             throttle=0.72, on_ground=False, running=True),
    Keyframe(210.0, gs_kt=120.0, ias_kt=114.0, agl_ft=3000.0, vs_fpm=0.0, rpm=2350.0,
             throttle=0.72, on_ground=False, running=True),
    # Descend, configure.
    Keyframe(240.0, gs_kt=105.0, ias_kt=100.0, agl_ft=1800.0, vs_fpm=-600.0, rpm=2100.0,
             throttle=0.45, on_ground=False, running=True),
    Keyframe(255.0, gs_kt=88.0, ias_kt=85.0, agl_ft=1200.0, vs_fpm=-550.0, rpm=1900.0,
             throttle=0.35, flaps=0.5, on_ground=False, running=True),
    Keyframe(268.0, gs_kt=75.0, ias_kt=72.0, agl_ft=700.0, vs_fpm=-500.0, rpm=1800.0,
             throttle=0.3, flaps=1.0, on_ground=False, running=True),
    Keyframe(282.0, gs_kt=68.0, ias_kt=66.0, agl_ft=120.0, vs_fpm=-450.0, rpm=1700.0,
             throttle=0.25, flaps=1.0, on_ground=False, running=True),
    # Flare.
    Keyframe(286.0, gs_kt=62.0, ias_kt=60.0, agl_ft=12.0, vs_fpm=-300.0, rpm=1500.0,
             throttle=0.1, flaps=1.0, on_ground=False, running=True),
    Keyframe(288.0, gs_kt=58.0, ias_kt=56.0, agl_ft=2.0, vs_fpm=-160.0, rpm=1200.0,
             throttle=0.05, flaps=1.0, on_ground=False, running=True),
    ...
    Keyframe(288.55, gs_kt=56.5, ias_kt=54.5, agl_ft=0.2, vs_fpm=-145.0, rpm=1100.0,
             throttle=0.0, flaps=1.0, on_ground=False, running=True),
    # Touchdown and rollout.
    Keyframe(288.6, gs_kt=56.0, ias_kt=54.0, agl_ft=0.0, vs_fpm=0.0, rpm=1000.0,
             throttle=0.0, flaps=1.0, on_ground=True, running=True),
    Keyframe(300.0, gs_kt=30.0, ias_kt=28.0, rpm=900.0, throttle=0.0, brake=0.7,
             flaps=1.0, running=True),
...
class SyntheticFlight:
    ...
    def sample_at(self, t: float) -> FlightTelemetry:
        ...
        # Gear compression eases off as the wings take the weight.
        if on_ground:
            lift_fraction = min(1.0, (ias / 62.0) ** 2) if ias > 0 else 0.0
